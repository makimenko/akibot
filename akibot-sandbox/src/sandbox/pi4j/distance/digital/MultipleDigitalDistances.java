...
public class MultipleDigitalDistances extends Thread {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		MultipleDigitalDistances dm0 = new MultipleDigitalDistances("/dev/ttyUSB0", "");
		MultipleDigitalDistances dm1 = new MultipleDigitalDistances("/dev/ttyUSB1", "     ");
		MultipleDigitalDistances dm2 = new MultipleDigitalDistances("/dev/ttyUSB2", "          ");
		MultipleDigitalDistances dm3 = new MultipleDigitalDistances("/dev/ttyUSB3", "               ");
	...
	public MultipleDigitalDistances(String device, String printPrefix) {
		this.device = device;
	...
	private void processByte(byte data) {
		...
		if (data == (byte) 0xFF) {
			...
			System.out.println(device + " = " + printPrefix + mili);
			count++;
		} else if (index == 4) {
