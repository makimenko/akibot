...
${OBJECTDIR}/EchoLocator.o: EchoLocator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/jdk-8-oracle-arm-vfp-hflt/include -I/usr/lib/jvm/jdk-8-oracle-arm-vfp-hflt/include/linux -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EchoLocator.o EchoLocator.cpp

${OBJECTDIR}/PCA9685.o: PCA9685.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/jdk-8-oracle-arm-vfp-hflt/include -I/usr/lib/jvm/jdk-8-oracle-arm-vfp-hflt/include/linux -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PCA9685.o PCA9685.cpp
