...
public class MultiAxisGyro_HMC5883L implements MultiAxisGyro {
	...
	public MultiAxisGyro_HMC5883L(I2CBus bus) throws IOException {
	...
	public void enable() throws IOException {
		...
		//
		// init[0] = (byte)((samplesAverage << 5) + (outputRate << 2) +
		// measurementMode);
		// init[1] = (byte)((gain << 5));
		// init[2] = (byte)(mode);
		//
	...
	public static void main(String[] args) throws Exception {
		...
		MultiAxisGyro_HMC5883L hmc5883l = new MultiAxisGyro_HMC5883L(bus);
